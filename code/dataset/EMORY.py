...
def save_npz(info, method_name, config, kind):
    ...
    if os.path.isfile(npz_prefix + f'EMORY_{method_name}_{kind}.npz'):
        print(f'EMORY_{method_name}_{kind}.npz exists! please delete it if you want to generate the new npz')
        return
